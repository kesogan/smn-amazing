...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{ asset('dashboard/assets/css/bootstrap-datepicker.css') }}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('dashboard/assets/css/daterangepicker.css') }}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{ asset('dashboard/assets/css/bootstrap3-wysihtml5.min.css') }}">
...
<script src="{{ asset('dashboard/assets/js/dataTables.bootstrap.min.js') }}"></script>

<script srs="{{ asset('dashboard/assets/js/raphael.js') }}"></script>
...
<!-- jvectormap -->
<script src="{{ asset('dashboard/assets/js/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('dashboard/assets/js/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('dashboard/assets/js/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('dashboard/assets/js/bootstrap3-wysihtml5.all.min.js') }}"></script>
<!-- Slimscroll -->
