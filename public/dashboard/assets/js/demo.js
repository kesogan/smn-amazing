...
jQuery(function () {
    ...
    jQuery(window).on('load', function() {
        ...
        $pushMenu = jQuery('[data-toggle="push-menu"]').data('lte.pushmenu')
        $controlSidebar = jQuery('[data-toggle="control-sidebar"]').data('lte.controlsidebar')
        $layout = jQuery('body').data('lte.layout')
    })
    ...
    var $skinsList = jQuery('<ul />', {'class': 'list-unstyled clearfix'})
