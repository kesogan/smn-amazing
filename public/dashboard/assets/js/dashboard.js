...
jQuery(function () {
  ...
  jQuery('.connectedSortable').sortable({
    containment         : jQuery('section.content'),
...
*/
  ...
  jQuery('.todo-list').todoList({
    onCheck  : function () {
      window.console.log(jQuery(this), 'The element has been checked');
    },
    onUnCheck: function () {
      window.console.log(jQuery(this), 'The element has been unchecked');
    }
  });
